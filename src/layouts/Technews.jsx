...
function Tech(){
    ...
    const [articles, setArticles] = useState([]);
      var URL = 'https://newsapi.org/v2/everything?sources=techcrunch&apiKey=fad69300e628408b848d23759c9d1440';
    ...
    return(
        ...
        <motion.div className="flex flex-row gap-1 w-full h-16 bg-gray-950 items-center justify-center text-lg md:text-2xl">
            <p className="font-Akira tracking-widest text-white"><span className="text-red-500">TECH</span> NEWS</p>
        </motion.div>
